...
func main() {
	fmt.Println("Testing forced metadata refresh...")
	...
	config.ClientID = "test-force-metadata"
	...
	// Force metadata refresh
	fmt.Println("Refreshing metadata...")
	err = client.RefreshMetadata()
	if err != nil {
		log.Fatalf("Failed to refresh metadata: %v", err)
	}

	fmt.Println("Metadata refreshed successfully")
	...
	fmt.Println("Forced metadata test completed successfully")
}
