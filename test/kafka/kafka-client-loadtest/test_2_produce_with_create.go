...
// Test 2: Create Topic and Produce Schematized Messages
// This test creates a topic explicitly, then produces Avro messages in Confluent Wire Format

func main() {
	log.Println("=== Test 2: Create Topic and Produce Schematized Messages ===")
	...
	// Step 2: Create topic explicitly
	log.Println("Step 2: Creating topic explicitly...")
	...
	// Step 3: Wait for topic to be ready
	time.Sleep(2 * time.Second)

	// Step 4: Create Avro codec
	log.Println("Step 3: Creating Avro codec...")
	...
	log.Println("Step 4: Creating Kafka producer...")
	...
	log.Println("Step 5: Producing schematized message...")
	...
	// Step 7: Check topic.conf for schema information
	log.Println("Step 6: Checking topic.conf for schema information...")
	time.Sleep(2 * time.Second)
	...
	// Step 8: Verify schema information
	log.Println("Step 7: Verifying schema information...")
...
func produceSchematizedMessage(producer sarama.SyncProducer, topicName string, schemaID int, codec *goavro.Codec) error {
	...
	log.Printf("  Message data: %+v", messageData)
