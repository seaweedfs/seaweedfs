...
func main() {
	fmt.Println("🧪 Testing System Topic Schema - Final Test")
	...
	// Test creating a new system topic with updated code
	systemTopicName := "__test_final_system_topic"
	topicDetail := &sarama.TopicDetail{
		NumPartitions:     2,
		ReplicationFactor: 1,
	}

	fmt.Printf("📝 Creating system topic with updated code: %s\n", systemTopicName)
