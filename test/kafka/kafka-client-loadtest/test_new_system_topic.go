...
func main() {
	fmt.Println("🧪 Testing New System Topic Default Schema")
	...
	// Test creating a new system topic
	systemTopicName := "__test_system_topic"
	topicDetail := &sarama.TopicDetail{
		NumPartitions:     2,
		ReplicationFactor: 1,
	}

	fmt.Printf("📝 Creating new system topic: %s\n", systemTopicName)
