...
type TelemetryData struct {
	...
	// Whether this cluster runs an enterprise build; carried separately from
	// the version string so the public dashboard does not single them out
	IsEnterprise  bool `protobuf:"varint,12,opt,name=is_enterprise,json=isEnterprise,proto3" json:"is_enterprise,omitempty"`
...
func (x *TelemetryData) GetIsEnterprise() bool {
	if x != nil {
...
const file_telemetry_proto_telemetry_proto_rawDesc = "" +
	"\n" +
	"\x1ftelemetry/proto/telemetry.proto\x12\ttelemetry\"\xf5\x02\n" +
	...
	"\ris_enterprise\x18\f \x01(\bR\fisEnterpriseJ\x04\b\x04\x10\x05J\x04\b\x05\x10\x06\"@\n" +
