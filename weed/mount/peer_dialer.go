...
// NewPeerConnPool returns an empty pool using cleartext by default.
// dialOpts are appended after the default transport credentials and
// apply to every dial the pool performs.
