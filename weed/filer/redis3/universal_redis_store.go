...
func (store *UniversalRedis3Store) FindVersionedEntry(ctx context.Context, fullpath util.FullPath, v uint64) (entry *filer.Entry, err error) {
...
func (store *UniversalRedis3Store) DeleteVersionedEntry(ctx context.Context, fullpath util.FullPath, v uint64) (err error) {
