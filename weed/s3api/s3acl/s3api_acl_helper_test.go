...
func (a *MockAccountManager) GetAccountNameById(id string) string {
	return a.accountNameById[id]
}

func (a *MockAccountManager) GetAccountIdByEmail(email string) string {
	return a.accountIdByEmail[email]
}

func init() {
	accountManager = &MockAccountManager{
		accountNameById: map[string]string{
			"accountA": "accountAName",
			"accountB": "accountBName",
		},
		accountIdByEmail: map[string]string{
			"accountA@example.com": "accountA",
			"accountB@example.com": "accountB",
		},
	}
}
