...
func (h *S3TablesHandler) handleDeleteTable(w http.ResponseWriter, r *http.Request, filerClient FilerClient) error {
	...
	err = filerClient.WithFilerClient(false, func(client filer_pb.SeaweedFilerClient) error {
		...
		return h.deleteTableLocationMapping(r.Context(), client, metadata.MetadataLocation)
	})
...
func (h *S3TablesHandler) handleUpdateTable(w http.ResponseWriter, r *http.Request, filerClient FilerClient) error {
	...
	err = filerClient.WithFilerClient(false, func(client filer_pb.SeaweedFilerClient) error {
		...
		return h.updateTableLocationMapping(r.Context(), client, metadata.MetadataLocation, tablePath)
	})
...
func (h *S3TablesHandler) updateTableLocationMapping(ctx context.Context, client filer_pb.SeaweedFilerClient, metadataLocation, tablePath string) error {
	...
	return h.upsertFile(ctx, client, GetTableLocationMappingPath(tableLocationBucket), []byte(tablePath))
}
