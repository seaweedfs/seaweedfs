...
type RemoteConf struct {
	...
	DownloadConcurrency             int32                  `protobuf:"varint,80,opt,name=download_concurrency,json=downloadConcurrency,proto3" json:"download_concurrency,omitempty"` // S3 SDK part download concurrency (default 1)
	CacheConcurrency                int32                  `protobuf:"varint,81,opt,name=cache_concurrency,json=cacheConcurrency,proto3" json:"cache_concurrency,omitempty"`          // chunk download parallelism (default 8)
	ReadTimeoutSeconds              int32                  `protobuf:"varint,82,opt,name=read_timeout_seconds,json=readTimeoutSeconds,proto3" json:"read_timeout_seconds,omitempty"`  // per-chunk read timeout in seconds (default 300)
...
func (x *RemoteConf) GetDownloadConcurrency() int32 {
	if x != nil {
...
func (x *RemoteConf) GetCacheConcurrency() int32 {
	if x != nil {
		return x.CacheConcurrency
	}
	return 0
}

func (x *RemoteConf) GetReadTimeoutSeconds() int32 {
	if x != nil {
...
const file_remote_proto_rawDesc = "" +
	"\n" +
	"\fremote.proto\x12\tremote_pb\"\xad\x0f\n" +
	"\n" +
	"RemoteConf\x12\x12\n" +
	...
	"\x0econtabo_region\x18G \x01(\tR\rcontaboRegion\x121\n" +
	"\x14download_concurrency\x18P \x01(\x05R\x13downloadConcurrency\x12+\n" +
	"\x11cache_concurrency\x18Q \x01(\x05R\x10cacheConcurrency\x120\n" +
	"\x14read_timeout_seconds\x18R \x01(\x05R\x12readTimeoutSeconds\"\xff\x01\n" +
