...
func (x *RemoteConf) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
func (x *RemoteConf) GetAccessKey() string {
	if x != nil {
		return x.AccessKey
	}
	return ""
...
func (x *RemoteConf) GetSecretKey() string {
	if x != nil {
		return x.SecretKey
	}
	return ""
...
var file_filer_proto_rawDesc = []byte{
	...
	0x08, 0x52, 0x08, 0x72, 0x65, 0x61, 0x64, 0x4f, 0x6e, 0x6c, 0x79, 0x22, 0x84, 0x01, 0x0a, 0x0a,
	...
	0x03, 0x75, 0x72, 0x6c, 0x12, 0x1d, 0x0a, 0x0a, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x5f, 0x6b,
	...
	0x65, 0x79, 0x32, 0xdc, 0x0c, 0x0a, 0x0c, 0x53, 0x65, 0x61, 0x77, 0x65, 0x65, 0x64, 0x46, 0x69,
