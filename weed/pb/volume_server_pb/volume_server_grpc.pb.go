...
type VolumeServerClient interface {
	...
	VolumeEcStatus(ctx context.Context, in *VolumeEcStatusRequest, opts ...grpc.CallOption) (*VolumeEcStatusResponse, error)
	// tiered storage
...
func (c *volumeServerClient) VolumeEcShardRead(ctx context.Context, in *VolumeEcShardReadRequest, opts ...grpc.CallOption) (VolumeServer_VolumeEcShardReadClient, error) {
	stream, err := c.cc.NewStream(ctx, &_VolumeServer_serviceDesc.Streams[7], "/volume_server_pb.VolumeServer/VolumeEcShardRead", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *volumeServerClient) VolumeEcStatus(ctx context.Context, in *VolumeEcStatusRequest, opts ...grpc.CallOption) (*VolumeEcStatusResponse, error) {
	out := new(VolumeEcStatusResponse)
	err := c.cc.Invoke(ctx, "/volume_server_pb.VolumeServer/VolumeEcStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *volumeServerClient) VolumeTierMoveDatToRemote(ctx context.Context, in *VolumeTierMoveDatToRemoteRequest, opts ...grpc.CallOption) (VolumeServer_VolumeTierMoveDatToRemoteClient, error) {
	stream, err := c.cc.NewStream(ctx, &_VolumeServer_serviceDesc.Streams[8], "/volume_server_pb.VolumeServer/VolumeTierMoveDatToRemote", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *volumeServerClient) VolumeTierMoveDatFromRemote(ctx context.Context, in *VolumeTierMoveDatFromRemoteRequest, opts ...grpc.CallOption) (VolumeServer_VolumeTierMoveDatFromRemoteClient, error) {
	stream, err := c.cc.NewStream(ctx, &_VolumeServer_serviceDesc.Streams[9], "/volume_server_pb.VolumeServer/VolumeTierMoveDatFromRemote", opts...)
	if err != nil {
		return nil, err
	}
...
type VolumeServerServer interface {
	...
	VolumeEcStatus(context.Context, *VolumeEcStatusRequest) (*VolumeEcStatusResponse, error)
	// tiered storage
...
func (UnimplementedVolumeServerServer) VolumeEcStatus(context.Context, *VolumeEcStatusRequest) (*VolumeEcStatusResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method VolumeEcStatus not implemented")
}
...
func _VolumeServer_VolumeEcStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VolumeEcStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VolumeServerServer).VolumeEcStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/volume_server_pb.VolumeServer/VolumeEcStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VolumeServerServer).VolumeEcStatus(ctx, req.(*VolumeEcStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _VolumeServer_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "VolumeEcStatus",
			Handler:    _VolumeServer_VolumeEcStatus_Handler,
		},
		{
