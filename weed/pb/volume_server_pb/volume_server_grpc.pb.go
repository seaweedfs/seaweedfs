...
type VolumeServerClient interface {
	...
	VolumeEcShardsGenerateStreaming(ctx context.Context, in *VolumeEcShardsGenerateRequest, opts ...grpc.CallOption) (VolumeServer_VolumeEcShardsGenerateStreamingClient, error)
...
func (c *volumeServerClient) ReceiveFile(ctx context.Context, opts ...grpc.CallOption) (VolumeServer_ReceiveFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &_VolumeServer_serviceDesc.Streams[4], "/volume_server_pb.VolumeServer/ReceiveFile", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *volumeServerClient) ReadAllNeedles(ctx context.Context, in *ReadAllNeedlesRequest, opts ...grpc.CallOption) (VolumeServer_ReadAllNeedlesClient, error) {
	stream, err := c.cc.NewStream(ctx, &_VolumeServer_serviceDesc.Streams[5], "/volume_server_pb.VolumeServer/ReadAllNeedles", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *volumeServerClient) VolumeTailSender(ctx context.Context, in *VolumeTailSenderRequest, opts ...grpc.CallOption) (VolumeServer_VolumeTailSenderClient, error) {
	stream, err := c.cc.NewStream(ctx, &_VolumeServer_serviceDesc.Streams[6], "/volume_server_pb.VolumeServer/VolumeTailSender", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *volumeServerClient) VolumeEcShardsGenerateStreaming(ctx context.Context, in *VolumeEcShardsGenerateRequest, opts ...grpc.CallOption) (VolumeServer_VolumeEcShardsGenerateStreamingClient, error) {
	stream, err := c.cc.NewStream(ctx, &_VolumeServer_serviceDesc.Streams[7], "/volume_server_pb.VolumeServer/VolumeEcShardsGenerateStreaming", opts...)
	if err != nil {
		return nil, err
	}
	x := &volumeServerVolumeEcShardsGenerateStreamingClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type VolumeServer_VolumeEcShardsGenerateStreamingClient interface {
	Recv() (*VolumeEcShardsGenerateStreamingResponse, error)
	grpc.ClientStream
}

type volumeServerVolumeEcShardsGenerateStreamingClient struct {
	grpc.ClientStream
}

func (x *volumeServerVolumeEcShardsGenerateStreamingClient) Recv() (*VolumeEcShardsGenerateStreamingResponse, error) {
	m := new(VolumeEcShardsGenerateStreamingResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *volumeServerClient) VolumeEcShardRead(ctx context.Context, in *VolumeEcShardReadRequest, opts ...grpc.CallOption) (VolumeServer_VolumeEcShardReadClient, error) {
	stream, err := c.cc.NewStream(ctx, &_VolumeServer_serviceDesc.Streams[8], "/volume_server_pb.VolumeServer/VolumeEcShardRead", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *volumeServerClient) VolumeEcShardsInfo(ctx context.Context, in *VolumeEcShardsInfoRequest, opts ...grpc.CallOption) (*VolumeEcShardsInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/volume_server_pb.VolumeServer/VolumeEcShardsInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *volumeServerClient) VolumeTierMoveDatToRemote(ctx context.Context, in *VolumeTierMoveDatToRemoteRequest, opts ...grpc.CallOption) (VolumeServer_VolumeTierMoveDatToRemoteClient, error) {
	stream, err := c.cc.NewStream(ctx, &_VolumeServer_serviceDesc.Streams[9], "/volume_server_pb.VolumeServer/VolumeTierMoveDatToRemote", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *volumeServerClient) VolumeTierMoveDatFromRemote(ctx context.Context, in *VolumeTierMoveDatFromRemoteRequest, opts ...grpc.CallOption) (VolumeServer_VolumeTierMoveDatFromRemoteClient, error) {
	stream, err := c.cc.NewStream(ctx, &_VolumeServer_serviceDesc.Streams[10], "/volume_server_pb.VolumeServer/VolumeTierMoveDatFromRemote", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *volumeServerClient) Query(ctx context.Context, in *QueryRequest, opts ...grpc.CallOption) (VolumeServer_QueryClient, error) {
	stream, err := c.cc.NewStream(ctx, &_VolumeServer_serviceDesc.Streams[11], "/volume_server_pb.VolumeServer/Query", opts...)
	if err != nil {
		return nil, err
	}
...
type VolumeServerServer interface {
	...
	VolumeEcShardsGenerateStreaming(*VolumeEcShardsGenerateRequest, VolumeServer_VolumeEcShardsGenerateStreamingServer) error
...
func (UnimplementedVolumeServerServer) VolumeEcShardsGenerateStreaming(*VolumeEcShardsGenerateRequest, VolumeServer_VolumeEcShardsGenerateStreamingServer) error {
	return status.Errorf(codes.Unimplemented, "method VolumeEcShardsGenerateStreaming not implemented")
}
...
func _VolumeServer_VolumeEcShardsGenerateStreaming_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(VolumeEcShardsGenerateRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(VolumeServerServer).VolumeEcShardsGenerateStreaming(m, &volumeServerVolumeEcShardsGenerateStreamingServer{stream})
}

type VolumeServer_VolumeEcShardsGenerateStreamingServer interface {
	Send(*VolumeEcShardsGenerateStreamingResponse) error
	grpc.ServerStream
}

type volumeServerVolumeEcShardsGenerateStreamingServer struct {
	grpc.ServerStream
}

func (x *volumeServerVolumeEcShardsGenerateStreamingServer) Send(m *VolumeEcShardsGenerateStreamingResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
func _VolumeServer_VolumeEcShardsInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/volume_server_pb.VolumeServer/VolumeEcShardsInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _VolumeServer_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "VolumeEcShardsGenerateStreaming",
			Handler:       _VolumeServer_VolumeEcShardsGenerateStreaming_Handler,
			ServerStreams: true,
		},
		{
