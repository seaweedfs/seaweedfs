...
const (
	...
	VolumeServer_WriteBlob_FullMethodName                   = "/volume_server_pb.VolumeServer/WriteBlob"
...
func (c *volumeServerClient) WriteBlob(ctx context.Context, in *WriteBlobRequest, opts ...grpc.CallOption) (*WriteBlobResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(WriteBlobResponse)
	err := c.cc.Invoke(ctx, VolumeServer_WriteBlob_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedVolumeServerServer) WriteBlob(context.Context, *WriteBlobRequest) (*WriteBlobResponse, error) {
...
func _VolumeServer_WriteBlob_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WriteBlobRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VolumeServerServer).WriteBlob(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: VolumeServer_WriteBlob_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VolumeServerServer).WriteBlob(ctx, req.(*WriteBlobRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var VolumeServer_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _VolumeServer_WriteBlob_Handler,
		},
		{
