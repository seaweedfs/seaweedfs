...
type VolumeEcShardsGenerateStreamingResponse struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	VolumeSize     uint64                 `protobuf:"varint,1,opt,name=volume_size,json=volumeSize,proto3" json:"volume_size,omitempty"`
...
func (x *VolumeEcShardsGenerateStreamingResponse) Reset() {
	*x = VolumeEcShardsGenerateStreamingResponse{}
	mi := &file_volume_server_proto_msgTypes[60]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *VolumeEcShardsGenerateStreamingResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VolumeEcShardsGenerateStreamingResponse) ProtoMessage() {}

func (x *VolumeEcShardsGenerateStreamingResponse) ProtoReflect() protoreflect.Message {
	mi := &file_volume_server_proto_msgTypes[60]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VolumeEcShardsGenerateStreamingResponse.ProtoReflect.Descriptor instead.
func (*VolumeEcShardsGenerateStreamingResponse) Descriptor() ([]byte, []int) {
	return file_volume_server_proto_rawDescGZIP(), []int{60}
}

func (x *VolumeEcShardsGenerateStreamingResponse) GetVolumeSize() uint64 {
	if x != nil {
		return x.VolumeSize
	}
	return 0
...
func (x *VolumeEcShardsGenerateStreamingResponse) GetProcessedBytes() uint64 {
	if x != nil {
		return x.ProcessedBytes
	}
	return 0
...
func (*FetchAndWriteNeedleRequest_Replica) Descriptor() ([]byte, []int) {
	return file_volume_server_proto_rawDescGZIP(), []int{96, 0}
}
...
func (*QueryRequest_Filter) Descriptor() ([]byte, []int) {
	return file_volume_server_proto_rawDescGZIP(), []int{102, 0}
}
...
func (*QueryRequest_InputSerialization) Descriptor() ([]byte, []int) {
	return file_volume_server_proto_rawDescGZIP(), []int{102, 1}
}
...
func (*QueryRequest_OutputSerialization) Descriptor() ([]byte, []int) {
	return file_volume_server_proto_rawDescGZIP(), []int{102, 2}
}
...
func (*QueryRequest_InputSerialization_CSVInput) Descriptor() ([]byte, []int) {
	return file_volume_server_proto_rawDescGZIP(), []int{102, 1, 0}
}
...
func (*QueryRequest_InputSerialization_JSONInput) Descriptor() ([]byte, []int) {
	return file_volume_server_proto_rawDescGZIP(), []int{102, 1, 1}
}
...
func (*QueryRequest_InputSerialization_ParquetInput) Descriptor() ([]byte, []int) {
	return file_volume_server_proto_rawDescGZIP(), []int{102, 1, 2}
}
...
func (*QueryRequest_OutputSerialization_CSVOutput) Descriptor() ([]byte, []int) {
	return file_volume_server_proto_rawDescGZIP(), []int{102, 2, 0}
}
...
func (*QueryRequest_OutputSerialization_JSONOutput) Descriptor() ([]byte, []int) {
	return file_volume_server_proto_rawDescGZIP(), []int{102, 2, 1}
}
...
const file_volume_server_proto_rawDesc = "" +
	...
	"collection\x18\x02 \x01(\tR\n" +
	"collection\" \n" +
	"\x1eVolumeEcShardsGenerateResponse\"s\n" +
	"'VolumeEcShardsGenerateStreamingResponse\x12\x1f\n" +
	"\vvolume_size\x18\x01 \x01(\x04R\n" +
	"volumeSize\x12'\n" +
	"\x0fprocessed_bytes\x18\x02 \x01(\x04R\x0eprocessedBytes\"[\n" +
	...
	"\x16VolumeEcShardsGenerate\x12/.volume_server_pb.VolumeEcShardsGenerateRequest\x1a0.volume_server_pb.VolumeEcShardsGenerateResponse\"\x00\x12\x91\x01\n" +
	"\x1fVolumeEcShardsGenerateStreaming\x12/.volume_server_pb.VolumeEcShardsGenerateRequest\x1a9.volume_server_pb.VolumeEcShardsGenerateStreamingResponse\"\x000\x01\x12z\n" +
...
var file_volume_server_proto_msgTypes = make([]protoimpl.MessageInfo, 117)
var file_volume_server_proto_goTypes = []any{
	...
	(*VolumeEcShardsGenerateStreamingResponse)(nil),      // 61: volume_server_pb.VolumeEcShardsGenerateStreamingResponse
	...
	(*ScrubVolumeRequest)(nil),                           // 99: volume_server_pb.ScrubVolumeRequest
	(*ScrubVolumeResponse)(nil),                          // 100: volume_server_pb.ScrubVolumeResponse
	(*ScrubEcVolumeRequest)(nil),                         // 101: volume_server_pb.ScrubEcVolumeRequest
	(*ScrubEcVolumeResponse)(nil),                        // 102: volume_server_pb.ScrubEcVolumeResponse
	(*QueryRequest)(nil),                                 // 103: volume_server_pb.QueryRequest
	(*QueriedStripe)(nil),                                // 104: volume_server_pb.QueriedStripe
	(*VolumeNeedleStatusRequest)(nil),                    // 105: volume_server_pb.VolumeNeedleStatusRequest
	(*VolumeNeedleStatusResponse)(nil),                   // 106: volume_server_pb.VolumeNeedleStatusResponse
	(*PingRequest)(nil),                                  // 107: volume_server_pb.PingRequest
	(*PingResponse)(nil),                                 // 108: volume_server_pb.PingResponse
	(*FetchAndWriteNeedleRequest_Replica)(nil),           // 109: volume_server_pb.FetchAndWriteNeedleRequest.Replica
	(*QueryRequest_Filter)(nil),                          // 110: volume_server_pb.QueryRequest.Filter
	(*QueryRequest_InputSerialization)(nil),              // 111: volume_server_pb.QueryRequest.InputSerialization
	(*QueryRequest_OutputSerialization)(nil),             // 112: volume_server_pb.QueryRequest.OutputSerialization
	(*QueryRequest_InputSerialization_CSVInput)(nil),     // 113: volume_server_pb.QueryRequest.InputSerialization.CSVInput
	(*QueryRequest_InputSerialization_JSONInput)(nil),    // 114: volume_server_pb.QueryRequest.InputSerialization.JSONInput
	(*QueryRequest_InputSerialization_ParquetInput)(nil), // 115: volume_server_pb.QueryRequest.InputSerialization.ParquetInput
	(*QueryRequest_OutputSerialization_CSVOutput)(nil),   // 116: volume_server_pb.QueryRequest.OutputSerialization.CSVOutput
	(*QueryRequest_OutputSerialization_JSONOutput)(nil),  // 117: volume_server_pb.QueryRequest.OutputSerialization.JSONOutput
	(*remote_pb.RemoteConf)(nil),                         // 118: remote_pb.RemoteConf
	(*remote_pb.RemoteStorageLocation)(nil),              // 119: remote_pb.RemoteStorageLocation
}
var file_volume_server_proto_depIdxs = []int32{
	...
	85,  // 9: volume_server_pb.OldVersionVolumeInfo.files:type_name -> volume_server_pb.RemoteFile
	83,  // 10: volume_server_pb.VolumeServerStatusResponse.disk_statuses:type_name -> volume_server_pb.DiskStatus
	84,  // 11: volume_server_pb.VolumeServerStatusResponse.memory_status:type_name -> volume_server_pb.MemStatus
	1,   // 12: volume_server_pb.VolumeServerStatusResponse.state:type_name -> volume_server_pb.VolumeServerState
	109, // 13: volume_server_pb.FetchAndWriteNeedleRequest.replicas:type_name -> volume_server_pb.FetchAndWriteNeedleRequest.Replica
	118, // 14: volume_server_pb.FetchAndWriteNeedleRequest.remote_conf:type_name -> remote_pb.RemoteConf
	119, // 15: volume_server_pb.FetchAndWriteNeedleRequest.remote_location:type_name -> remote_pb.RemoteStorageLocation
	...
	80,  // 18: volume_server_pb.ScrubEcVolumeResponse.broken_shard_infos:type_name -> volume_server_pb.EcShardInfo
	110, // 19: volume_server_pb.QueryRequest.filter:type_name -> volume_server_pb.QueryRequest.Filter
	111, // 20: volume_server_pb.QueryRequest.input_serialization:type_name -> volume_server_pb.QueryRequest.InputSerialization
	112, // 21: volume_server_pb.QueryRequest.output_serialization:type_name -> volume_server_pb.QueryRequest.OutputSerialization
	113, // 22: volume_server_pb.QueryRequest.InputSerialization.csv_input:type_name -> volume_server_pb.QueryRequest.InputSerialization.CSVInput
	114, // 23: volume_server_pb.QueryRequest.InputSerialization.json_input:type_name -> volume_server_pb.QueryRequest.InputSerialization.JSONInput
	115, // 24: volume_server_pb.QueryRequest.InputSerialization.parquet_input:type_name -> volume_server_pb.QueryRequest.InputSerialization.ParquetInput
	116, // 25: volume_server_pb.QueryRequest.OutputSerialization.csv_output:type_name -> volume_server_pb.QueryRequest.OutputSerialization.CSVOutput
	117, // 26: volume_server_pb.QueryRequest.OutputSerialization.json_output:type_name -> volume_server_pb.QueryRequest.OutputSerialization.JSONOutput
	...
	81,  // 46: volume_server_pb.VolumeServer.ReadVolumeFileStatus:input_type -> volume_server_pb.ReadVolumeFileStatusRequest
	...
	59,  // 56: volume_server_pb.VolumeServer.VolumeEcShardsGenerateStreaming:input_type -> volume_server_pb.VolumeEcShardsGenerateRequest
	62,  // 57: volume_server_pb.VolumeServer.VolumeEcShardsRebuild:input_type -> volume_server_pb.VolumeEcShardsRebuildRequest
	64,  // 58: volume_server_pb.VolumeServer.VolumeEcShardsCopy:input_type -> volume_server_pb.VolumeEcShardsCopyRequest
	66,  // 59: volume_server_pb.VolumeServer.VolumeEcShardsDelete:input_type -> volume_server_pb.VolumeEcShardsDeleteRequest
	68,  // 60: volume_server_pb.VolumeServer.VolumeEcShardsMount:input_type -> volume_server_pb.VolumeEcShardsMountRequest
	70,  // 61: volume_server_pb.VolumeServer.VolumeEcShardsUnmount:input_type -> volume_server_pb.VolumeEcShardsUnmountRequest
	72,  // 62: volume_server_pb.VolumeServer.VolumeEcShardRead:input_type -> volume_server_pb.VolumeEcShardReadRequest
	74,  // 63: volume_server_pb.VolumeServer.VolumeEcBlobDelete:input_type -> volume_server_pb.VolumeEcBlobDeleteRequest
	76,  // 64: volume_server_pb.VolumeServer.VolumeEcShardsToVolume:input_type -> volume_server_pb.VolumeEcShardsToVolumeRequest
	78,  // 65: volume_server_pb.VolumeServer.VolumeEcShardsInfo:input_type -> volume_server_pb.VolumeEcShardsInfoRequest
	89,  // 66: volume_server_pb.VolumeServer.VolumeTierMoveDatToRemote:input_type -> volume_server_pb.VolumeTierMoveDatToRemoteRequest
	91,  // 67: volume_server_pb.VolumeServer.VolumeTierMoveDatFromRemote:input_type -> volume_server_pb.VolumeTierMoveDatFromRemoteRequest
	93,  // 68: volume_server_pb.VolumeServer.VolumeServerStatus:input_type -> volume_server_pb.VolumeServerStatusRequest
	95,  // 69: volume_server_pb.VolumeServer.VolumeServerLeave:input_type -> volume_server_pb.VolumeServerLeaveRequest
	97,  // 70: volume_server_pb.VolumeServer.FetchAndWriteNeedle:input_type -> volume_server_pb.FetchAndWriteNeedleRequest
	99,  // 71: volume_server_pb.VolumeServer.ScrubVolume:input_type -> volume_server_pb.ScrubVolumeRequest
	101, // 72: volume_server_pb.VolumeServer.ScrubEcVolume:input_type -> volume_server_pb.ScrubEcVolumeRequest
	103, // 73: volume_server_pb.VolumeServer.Query:input_type -> volume_server_pb.QueryRequest
	105, // 74: volume_server_pb.VolumeServer.VolumeNeedleStatus:input_type -> volume_server_pb.VolumeNeedleStatusRequest
	107, // 75: volume_server_pb.VolumeServer.Ping:input_type -> volume_server_pb.PingRequest
	...
	82,  // 95: volume_server_pb.VolumeServer.ReadVolumeFileStatus:output_type -> volume_server_pb.ReadVolumeFileStatusResponse
	...
	50,  // 99: volume_server_pb.VolumeServer.ReadNeedleMeta:output_type -> volume_server_pb.ReadNeedleMetaResponse
	52,  // 100: volume_server_pb.VolumeServer.WriteNeedleBlob:output_type -> volume_server_pb.WriteNeedleBlobResponse
	54,  // 101: volume_server_pb.VolumeServer.ReadAllNeedles:output_type -> volume_server_pb.ReadAllNeedlesResponse
	56,  // 102: volume_server_pb.VolumeServer.VolumeTailSender:output_type -> volume_server_pb.VolumeTailSenderResponse
	58,  // 103: volume_server_pb.VolumeServer.VolumeTailReceiver:output_type -> volume_server_pb.VolumeTailReceiverResponse
	60,  // 104: volume_server_pb.VolumeServer.VolumeEcShardsGenerate:output_type -> volume_server_pb.VolumeEcShardsGenerateResponse
	61,  // 105: volume_server_pb.VolumeServer.VolumeEcShardsGenerateStreaming:output_type -> volume_server_pb.VolumeEcShardsGenerateStreamingResponse
	63,  // 106: volume_server_pb.VolumeServer.VolumeEcShardsRebuild:output_type -> volume_server_pb.VolumeEcShardsRebuildResponse
	65,  // 107: volume_server_pb.VolumeServer.VolumeEcShardsCopy:output_type -> volume_server_pb.VolumeEcShardsCopyResponse
	67,  // 108: volume_server_pb.VolumeServer.VolumeEcShardsDelete:output_type -> volume_server_pb.VolumeEcShardsDeleteResponse
	69,  // 109: volume_server_pb.VolumeServer.VolumeEcShardsMount:output_type -> volume_server_pb.VolumeEcShardsMountResponse
	71,  // 110: volume_server_pb.VolumeServer.VolumeEcShardsUnmount:output_type -> volume_server_pb.VolumeEcShardsUnmountResponse
	73,  // 111: volume_server_pb.VolumeServer.VolumeEcShardRead:output_type -> volume_server_pb.VolumeEcShardReadResponse
	75,  // 112: volume_server_pb.VolumeServer.VolumeEcBlobDelete:output_type -> volume_server_pb.VolumeEcBlobDeleteResponse
	77,  // 113: volume_server_pb.VolumeServer.VolumeEcShardsToVolume:output_type -> volume_server_pb.VolumeEcShardsToVolumeResponse
	79,  // 114: volume_server_pb.VolumeServer.VolumeEcShardsInfo:output_type -> volume_server_pb.VolumeEcShardsInfoResponse
	90,  // 115: volume_server_pb.VolumeServer.VolumeTierMoveDatToRemote:output_type -> volume_server_pb.VolumeTierMoveDatToRemoteResponse
	92,  // 116: volume_server_pb.VolumeServer.VolumeTierMoveDatFromRemote:output_type -> volume_server_pb.VolumeTierMoveDatFromRemoteResponse
	94,  // 117: volume_server_pb.VolumeServer.VolumeServerStatus:output_type -> volume_server_pb.VolumeServerStatusResponse
	96,  // 118: volume_server_pb.VolumeServer.VolumeServerLeave:output_type -> volume_server_pb.VolumeServerLeaveResponse
	98,  // 119: volume_server_pb.VolumeServer.FetchAndWriteNeedle:output_type -> volume_server_pb.FetchAndWriteNeedleResponse
	100, // 120: volume_server_pb.VolumeServer.ScrubVolume:output_type -> volume_server_pb.ScrubVolumeResponse
	102, // 121: volume_server_pb.VolumeServer.ScrubEcVolume:output_type -> volume_server_pb.ScrubEcVolumeResponse
	104, // 122: volume_server_pb.VolumeServer.Query:output_type -> volume_server_pb.QueriedStripe
	106, // 123: volume_server_pb.VolumeServer.VolumeNeedleStatus:output_type -> volume_server_pb.VolumeNeedleStatusResponse
	108, // 124: volume_server_pb.VolumeServer.Ping:output_type -> volume_server_pb.PingResponse
