...
func (c *seaweedClient) CreateBlockVolume(ctx context.Context, in *CreateBlockVolumeRequest, opts ...grpc.CallOption) (*CreateBlockVolumeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateBlockVolumeResponse)
	err := c.cc.Invoke(ctx, Seaweed_CreateBlockVolume_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *seaweedClient) DeleteBlockVolume(ctx context.Context, in *DeleteBlockVolumeRequest, opts ...grpc.CallOption) (*DeleteBlockVolumeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeleteBlockVolumeResponse)
	err := c.cc.Invoke(ctx, Seaweed_DeleteBlockVolume_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *seaweedClient) LookupBlockVolume(ctx context.Context, in *LookupBlockVolumeRequest, opts ...grpc.CallOption) (*LookupBlockVolumeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LookupBlockVolumeResponse)
	err := c.cc.Invoke(ctx, Seaweed_LookupBlockVolume_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSeaweedServer) CreateBlockVolume(context.Context, *CreateBlockVolumeRequest) (*CreateBlockVolumeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateBlockVolume not implemented")
}
func (UnimplementedSeaweedServer) DeleteBlockVolume(context.Context, *DeleteBlockVolumeRequest) (*DeleteBlockVolumeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteBlockVolume not implemented")
}
...
func _Seaweed_CreateBlockVolume_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateBlockVolumeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SeaweedServer).CreateBlockVolume(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Seaweed_CreateBlockVolume_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SeaweedServer).CreateBlockVolume(ctx, req.(*CreateBlockVolumeRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Seaweed_DeleteBlockVolume_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteBlockVolumeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SeaweedServer).DeleteBlockVolume(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Seaweed_DeleteBlockVolume_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SeaweedServer).DeleteBlockVolume(ctx, req.(*DeleteBlockVolumeRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Seaweed_LookupBlockVolume_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LookupBlockVolumeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SeaweedServer).LookupBlockVolume(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Seaweed_LookupBlockVolume_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SeaweedServer).LookupBlockVolume(ctx, req.(*LookupBlockVolumeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Seaweed_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CreateBlockVolume",
			Handler:    _Seaweed_CreateBlockVolume_Handler,
		},
		{
			MethodName: "DeleteBlockVolume",
			Handler:    _Seaweed_DeleteBlockVolume_Handler,
		},
		{
