...
const (
	...
	Seaweed_CollectionMark_FullMethodName         = "/master_pb.Seaweed/CollectionMark"
...
type SeaweedClient interface {
	...
	CollectionMark(ctx context.Context, in *CollectionMarkRequest, opts ...grpc.CallOption) (*CollectionMarkResponse, error)
...
func (c *seaweedClient) CollectionMark(ctx context.Context, in *CollectionMarkRequest, opts ...grpc.CallOption) (*CollectionMarkResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CollectionMarkResponse)
	err := c.cc.Invoke(ctx, Seaweed_CollectionMark_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SeaweedServer interface {
	...
	CollectionMark(context.Context, *CollectionMarkRequest) (*CollectionMarkResponse, error)
...
func (UnimplementedSeaweedServer) CollectionMark(context.Context, *CollectionMarkRequest) (*CollectionMarkResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CollectionMark not implemented")
}
...
func _Seaweed_CollectionMark_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CollectionMarkRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SeaweedServer).CollectionMark(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Seaweed_CollectionMark_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SeaweedServer).CollectionMark(ctx, req.(*CollectionMarkRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Seaweed_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CollectionMark",
			Handler:    _Seaweed_CollectionMark_Handler,
		},
		{
