...
func init() {
	...
	syncOptions.parallelBatchSize = cmdFilerSynchronize.Flag.Int("parallelBatchSize", 500, "maximum size of events to send in a batch")
	syncOptions.parallelWaitTime = cmdFilerSynchronize.Flag.String("parallelWaitTime", "3s", "maximum wait time of events to send")
