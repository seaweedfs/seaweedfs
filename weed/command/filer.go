...
func init() {
	...
	filerS3Options.lanceManagedVersioning = cmdFiler.Flag.Bool("s3.lance.managedVersioning", false, "let the Lance namespace order commits as an external manifest store")
