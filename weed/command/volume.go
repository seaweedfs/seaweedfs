...
func init() {
	...
	v.ldbTimeout = cmdVolume.Flag.Int64("ldbTimeout", 0, "alive time for leveldb (default to 0). If leveldb of volume is not accessed in ldbTimeout days, it will be off loaded.")
