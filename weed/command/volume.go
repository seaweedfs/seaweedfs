...
func init() {
	...
	v.readBufSize = cmdVolume.Flag.Int("readBufSize", 1024 * 1024, "larger values can optimize query performance but will increase some memory usage,Use with hasSlowRead normally.")
}
