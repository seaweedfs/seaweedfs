...
func initMiniS3Flags() {
	...
	miniS3Options.lanceManagedVersioning = cmdMini.Flag.Bool("s3.lance.managedVersioning", false, "let the Lance namespace order commits as an external manifest store")
