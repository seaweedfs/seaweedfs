...
func initMiniVolumeFlags() {
	...
	miniOptions.v.datFolder = cmdMini.Flag.String("volume.dir.dat", "", "directory to store .dat and .cpd files (e.g. HM-SMR sequential write zone). Defaults to -dir if empty.")
