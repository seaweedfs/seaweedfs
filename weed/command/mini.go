...
func initMiniFilerFlags() {
	...
	miniFilerOptions.tusSessionExpiry = cmdMini.Flag.Duration("filer.tusSessionExpiry", 7*24*time.Hour, "incomplete TUS upload sessions are cleaned up after this duration")
}
