...
func init() {
	...
	s3Options.lanceManagedVersioning = cmdServer.Flag.Bool("s3.lance.managedVersioning", false, "let the Lance namespace order commits as an external manifest store")
