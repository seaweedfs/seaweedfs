...
func init() {
	...
	serverOptions.v.ldbTimeout = cmdServer.Flag.Int64("volume.ldbTimeout", 0, "alive time for leveldb (default to 0). If leveldb of volume is not accessed in ldbTimeout hours, it will be off loaded.")
