...
func init() {
	...
	serverOptions.v.inflightDownloadDataTimeout = cmdServer.Flag.Duration("inflightDownloadDataTimeout", 60*time.Second, "inflight download data wait timeout of volume servers")
