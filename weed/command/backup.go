...
func runBackup(cmd *Command, args []string) bool {
	...
	lookup, err := operation.LookupVolumeId(context.Background(), func(_ context.Context) pb.ServerAddress { return pb.ServerAddress(*s.master) }, grpcDialOption, vid.String())
	if err != nil {
