...
func NewIamApiServer(router *mux.Router, option *IamServerOption) (iamApiServer *IamApiServer, err error) {
	s3ApiConfigure = IamS3ApiConfigure{
		option:       option,
		masterClient: wdclient.NewMasterClient(option.GrpcDialOptions, "iam", "", "", option.Masters),
	}
...
func (iam IamS3ApiConfigure) GetS3ApiConfiguration(s3cfg *iam_pb.S3ApiConfiguration) (err error) {
	...
	err = pb.WithGrpcFilerClient(false, iam.option.Filer, iam.option.GrpcDialOptions, func(client filer_pb.SeaweedFilerClient) error {
...
func (iam IamS3ApiConfigure) PutS3ApiConfiguration(s3cfg *iam_pb.S3ApiConfiguration) (err error) {
	...
	return pb.WithGrpcFilerClient(false, iam.option.Filer, iam.option.GrpcDialOptions, func(client filer_pb.SeaweedFilerClient) error {
