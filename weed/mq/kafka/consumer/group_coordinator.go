...
type GroupMember struct {
	...
	ClientID         string                // Client ID from consumer (raw Kafka header value; not unique across connections)
	ConnectionID     string                // TCP connection identifier; distinguishes consumers that share a ClientID
