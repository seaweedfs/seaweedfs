...
func ClusterBrokers(data dash.ClusterBrokersData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/cluster_brokers.templ`, Line: 34, Col: 47}
		}
		...
		if len(data.Brokers) > 0 {
			...
			for _, broker := range data.Brokers {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/cluster_brokers.templ`, Line: 70, Col: 27}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/cluster_brokers.templ`, Line: 73, Col: 66}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/cluster_brokers.templ`, Line: 76, Col: 69}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/cluster_brokers.templ`, Line: 79, Col: 63}
				}
				...
				if !broker.CreatedAt.IsZero() {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/cluster_brokers.templ`, Line: 83, Col: 60}
					}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/cluster_brokers.templ`, Line: 108, Col: 67}
		}
