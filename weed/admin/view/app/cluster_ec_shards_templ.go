	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if data.FilterCollection != "" {
			...
			if data.FilterCollection == "default" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_ec_shards.templ`, Line: 22, Col: 96}
				}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_ec_shards.templ`, Line: 54, Col: 81}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_ec_shards.templ`, Line: 69, Col: 82}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_ec_shards.templ`, Line: 84, Col: 90}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_ec_shards.templ`, Line: 100, Col: 94}
		}
		...
		for _, shard := range data.EcShards {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_ec_shards.templ`, Line: 203, Col: 84}
			}
			...
			if data.ShowCollectionColumn {
				...
				if shard.Collection != "" {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_ec_shards.templ`, Line: 209, Col: 96}
					}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_ec_shards.templ`, Line: 219, Col: 61}
			}
			...
			if data.ShowDataCenterColumn {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_ec_shards.templ`, Line: 223, Col: 88}
				}
			...
			if data.ShowRackColumn {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_ec_shards.templ`, Line: 228, Col: 84}
				}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_ec_shards.templ`, Line: 241, Col: 90}
			}
			...
			if !shard.IsComplete {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_ec_shards.templ`, Line: 248, Col: 94}
				}
		...
		if data.TotalPages > 1 {
			...
			if data.CurrentPage > 1 {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_ec_shards.templ`, Line: 267, Col: 129}
				}
			...
			if data.CurrentPage > 1 && data.CurrentPage-1 >= 1 {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_ec_shards.templ`, Line: 288, Col: 129}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_ec_shards.templ`, Line: 288, Col: 170}
				}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_ec_shards.templ`, Line: 293, Col: 80}
			}
			...
			if data.CurrentPage < data.TotalPages && data.CurrentPage+1 <= data.TotalPages {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_ec_shards.templ`, Line: 298, Col: 129}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_ec_shards.templ`, Line: 298, Col: 170}
				}
			...
			if data.CurrentPage < data.TotalPages-2 {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_ec_shards.templ`, Line: 310, Col: 126}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_ec_shards.templ`, Line: 310, Col: 164}
				}
			...
			if data.CurrentPage < data.TotalPages {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_ec_shards.templ`, Line: 316, Col: 129}
				}
...
func displayShardDistribution(shard dash.EcShardWithInfo, allShards []dash.EcShardWithInfo) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_ec_shards.templ`, Line: 418, Col: 65}
		}
	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if shard.IsComplete {
			...
			if len(shard.MissingShards) > 10 {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_ec_shards.templ`, Line: 428, Col: 129}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_ec_shards.templ`, Line: 430, Col: 145}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_ec_shards.templ`, Line: 432, Col: 138}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_ec_shards.templ`, Line: 434, Col: 137}
				}
