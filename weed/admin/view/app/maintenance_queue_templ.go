...
func MaintenanceQueue(data *maintenance.MaintenanceQueueData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `maintenance_queue.templ`, Line: 39, Col: 84}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `maintenance_queue.templ`, Line: 48, Col: 84}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `maintenance_queue.templ`, Line: 57, Col: 86}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `maintenance_queue.templ`, Line: 66, Col: 83}
		}
			...
			for _, task := range data.Tasks {
				if string(task.Status) == "completed" || string(task.Status) == "failed" || string(task.Status) == "cancelled" {
					if string(task.Status) == "failed" {
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `maintenance_queue.templ`, Line: 107, Col: 112}
						}
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `maintenance_queue.templ`, Line: 110, Col: 78}
						}
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `maintenance_queue.templ`, Line: 113, Col: 93}
						}
						...
						if task.WorkerID != "" {
							...
							if templ_7745c5c3_Err != nil {
								return templ.Error{Err: templ_7745c5c3_Err, FileName: `maintenance_queue.templ`, Line: 116, Col: 85}
							}
						...
						if task.StartedAt != nil && task.CompletedAt != nil {
							...
							if templ_7745c5c3_Err != nil {
								return templ.Error{Err: templ_7745c5c3_Err, FileName: `maintenance_queue.templ`, Line: 123, Col: 118}
							}
						...
						if task.CompletedAt != nil {
							...
							if templ_7745c5c3_Err != nil {
								return templ.Error{Err: templ_7745c5c3_Err, FileName: `maintenance_queue.templ`, Line: 130, Col: 108}
							}
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `maintenance_queue.templ`, Line: 137, Col: 99}
						}
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `maintenance_queue.templ`, Line: 140, Col: 78}
						}
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `maintenance_queue.templ`, Line: 143, Col: 93}
						}
						...
						if task.WorkerID != "" {
							...
							if templ_7745c5c3_Err != nil {
								return templ.Error{Err: templ_7745c5c3_Err, FileName: `maintenance_queue.templ`, Line: 146, Col: 85}
							}
						...
						if task.StartedAt != nil && task.CompletedAt != nil {
							...
							if templ_7745c5c3_Err != nil {
								return templ.Error{Err: templ_7745c5c3_Err, FileName: `maintenance_queue.templ`, Line: 153, Col: 118}
							}
						...
						if task.CompletedAt != nil {
							...
							if templ_7745c5c3_Err != nil {
								return templ.Error{Err: templ_7745c5c3_Err, FileName: `maintenance_queue.templ`, Line: 160, Col: 108}
							}
		...
		if data.Stats.PendingTasks == 0 {
			...
			for _, task := range data.Tasks {
				if string(task.Status) == "pending" {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `maintenance_queue.templ`, Line: 211, Col: 95}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `maintenance_queue.templ`, Line: 214, Col: 74}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `maintenance_queue.templ`, Line: 217, Col: 89}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `maintenance_queue.templ`, Line: 218, Col: 75}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `maintenance_queue.templ`, Line: 219, Col: 75}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `maintenance_queue.templ`, Line: 220, Col: 98}
					}
		...
		if data.Stats.RunningTasks == 0 {
			...
			for _, task := range data.Tasks {
				if string(task.Status) == "assigned" || string(task.Status) == "in_progress" {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `maintenance_queue.templ`, Line: 266, Col: 95}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `maintenance_queue.templ`, Line: 269, Col: 74}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `maintenance_queue.templ`, Line: 273, Col: 89}
					}
					...
					if task.WorkerID != "" {
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `maintenance_queue.templ`, Line: 276, Col: 81}
						}
					...
					if task.StartedAt != nil {
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `maintenance_queue.templ`, Line: 283, Col: 102}
						}
...
func TaskTypeIcon(taskType maintenance.MaintenanceTaskType) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `maintenance_queue.templ`, Line: 1, Col: 0}
		}
...
func ProgressBar(progress float64, status maintenance.MaintenanceTaskStatus) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if status == maintenance.TaskStatusInProgress || status == maintenance.TaskStatusAssigned {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `maintenance_queue.templ`, Line: 386, Col: 102}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `maintenance_queue.templ`, Line: 389, Col: 66}
			}
