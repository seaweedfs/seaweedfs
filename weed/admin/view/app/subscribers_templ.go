...
func Subscribers(data dash.SubscribersData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/subscribers.templ`, Line: 12, Col: 107}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/subscribers.templ`, Line: 21, Col: 98}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/subscribers.templ`, Line: 29, Col: 99}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/subscribers.templ`, Line: 37, Col: 123}
		}
		...
		if len(data.Subscribers) == 0 {
			...
			for _, subscriber := range data.Subscribers {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/subscribers.templ`, Line: 78, Col: 76}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/subscribers.templ`, Line: 81, Col: 97}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/subscribers.templ`, Line: 83, Col: 77}
				}
				...
				if subscriber.Status == "active" {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/subscribers.templ`, Line: 90, Col: 107}
					}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/subscribers.templ`, Line: 93, Col: 95}
				}
				...
				if !subscriber.LastSeen.IsZero() {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/subscribers.templ`, Line: 96, Col: 131}
					}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/subscribers.templ`, Line: 102, Col: 128}
				}
