...
func ClusterEcVolumes(data dash.ClusterEcVolumesData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if data.Collection != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/cluster_ec_volumes.templ`, Line: 28, Col: 67}
			}
		...
		for _, volume := range data.EcVolumes {
			...
			if data.ShowCollectionColumn {
				...
				if volume.Collection != "" {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/cluster_ec_volumes.templ`, Line: 204, Col: 128}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/cluster_ec_volumes.templ`, Line: 208, Col: 101}
					}
