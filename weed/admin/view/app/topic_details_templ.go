...
func TopicDetails(data dash.TopicDetailsData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 17, Col: 102}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 20, Col: 74}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 22, Col: 107}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 31, Col: 97}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 39, Col: 117}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 47, Col: 94}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 55, Col: 107}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 63, Col: 97}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 71, Col: 95}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 83, Col: 107}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 100, Col: 72}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 102, Col: 67}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 104, Col: 72}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 106, Col: 102}
		}
		...
		if data.Retention.Enabled {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 135, Col: 95}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 135, Col: 124}
			}
		...
		if len(data.KeySchema) == 0 && len(data.ValueSchema) == 0 {
			...
			for _, field := range data.KeySchema {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 171, Col: 77}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 172, Col: 104}
				}
			...
			for _, field := range data.ValueSchema {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 185, Col: 77}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 186, Col: 104}
				}
		...
		if len(data.Partitions) == 0 {
			...
			for _, partition := range data.Partitions {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 241, Col: 115}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 244, Col: 83}
				}
				...
				if partition.FollowerBroker != "" {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 248, Col: 106}
					}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 253, Col: 94}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 254, Col: 107}
				}
				...
				if !partition.LastDataTime.IsZero() {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 257, Col: 134}
					}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 263, Col: 127}
				}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 279, Col: 138}
		}
		...
		if len(data.Publishers) == 0 {
			...
			for _, publisher := range data.Publishers {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 303, Col: 84}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 304, Col: 132}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 305, Col: 77}
				}
				...
				if publisher.LastPublishedOffset > 0 {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 315, Col: 138}
					}
				...
				if publisher.LastAckedOffset > 0 {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 322, Col: 134}
					}
				...
				if !publisher.LastSeenTime.IsZero() {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 329, Col: 131}
					}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 349, Col: 137}
		}
		...
		if len(data.Subscribers) == 0 {
			...
			for _, subscriber := range data.Subscribers {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 374, Col: 85}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 375, Col: 82}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 376, Col: 133}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 377, Col: 78}
				}
				...
				if subscriber.LastReceivedOffset > 0 {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 387, Col: 138}
					}
				...
				if subscriber.CurrentOffset > 0 {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 394, Col: 133}
					}
				...
				if !subscriber.LastSeenTime.IsZero() {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 401, Col: 132}
					}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 422, Col: 153}
		}
		...
		if len(data.ConsumerGroupOffsets) == 0 {
			...
			for _, offset := range data.ConsumerGroupOffsets {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 444, Col: 114}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 447, Col: 129}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 450, Col: 101}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `topic_details.templ`, Line: 453, Col: 134}
				}
