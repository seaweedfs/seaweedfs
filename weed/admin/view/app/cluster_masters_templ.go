...
func ClusterMasters(data dash.ClusterMastersData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_masters.templ`, Line: 34, Col: 47}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_masters.templ`, Line: 54, Col: 46}
		}
		...
		if len(data.Masters) > 0 {
			...
			for _, master := range data.Masters {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_masters.templ`, Line: 113, Col: 76}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_masters.templ`, Line: 114, Col: 28}
				}
				...
				if master.Suffrage != "" {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_masters.templ`, Line: 132, Col: 30}
					}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_masters.templ`, Line: 143, Col: 41}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_masters.templ`, Line: 144, Col: 60}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_masters.templ`, Line: 145, Col: 43}
				}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_masters.templ`, Line: 169, Col: 67}
		}
