...
func MaintenanceWorkers(data *dash.MaintenanceWorkersData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/maintenance_workers.templ`, Line: 19, Col: 112}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/maintenance_workers.templ`, Line: 35, Col: 122}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/maintenance_workers.templ`, Line: 54, Col: 75}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/maintenance_workers.templ`, Line: 74, Col: 73}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/maintenance_workers.templ`, Line: 94, Col: 71}
		}
		...
		if len(data.Workers) == 0 {
			...
			for _, worker := range data.Workers {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/maintenance_workers.templ`, Line: 144, Col: 76}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/maintenance_workers.templ`, Line: 147, Col: 81}
				}
				...
				for _, capability := range worker.Worker.Capabilities {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/maintenance_workers.templ`, Line: 161, Col: 126}
					}
				...
				if worker.Worker.MaxConcurrent > 0 {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/maintenance_workers.templ`, Line: 169, Col: 160}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/maintenance_workers.templ`, Line: 170, Col: 125}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/maintenance_workers.templ`, Line: 172, Col: 127}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/maintenance_workers.templ`, Line: 173, Col: 142}
					}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/maintenance_workers.templ`, Line: 181, Col: 97}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/maintenance_workers.templ`, Line: 185, Col: 122}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/maintenance_workers.templ`, Line: 186, Col: 116}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/maintenance_workers.templ`, Line: 187, Col: 126}
				}
				...
				if time.Since(worker.Worker.LastHeartbeat) < 2*time.Minute {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/maintenance_workers.templ`, Line: 194, Col: 108}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/maintenance_workers.templ`, Line: 199, Col: 108}
					}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/maintenance_workers.templ`, Line: 205, Col: 175}
				}
				...
				if worker.Worker.Status == "active" {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/maintenance_workers.templ`, Line: 209, Col: 176}
					}
