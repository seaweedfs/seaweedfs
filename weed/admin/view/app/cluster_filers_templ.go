...
func ClusterFilers(data dash.ClusterFilersData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_filers.templ`, Line: 34, Col: 46}
		}
		...
		if len(data.Filers) > 0 {
			...
			for _, filer := range data.Filers {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_filers.templ`, Line: 71, Col: 75}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_filers.templ`, Line: 72, Col: 27}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_filers.templ`, Line: 77, Col: 65}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_filers.templ`, Line: 80, Col: 68}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_filers.templ`, Line: 83, Col: 62}
				}
				...
				if !filer.CreatedAt.IsZero() {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_filers.templ`, Line: 87, Col: 59}
					}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_filers.templ`, Line: 94, Col: 149}
				}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/cluster_filers.templ`, Line: 119, Col: 67}
		}
