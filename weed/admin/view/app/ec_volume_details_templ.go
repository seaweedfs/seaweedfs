...
func EcVolumeDetails(data dash.EcVolumeDetailsData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/ec_volume_details.templ`, Line: 18, Col: 115}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/ec_volume_details.templ`, Line: 47, Col: 65}
		}
		...
		if data.Collection != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/ec_volume_details.templ`, Line: 53, Col: 80}
			}
		...
		if data.IsComplete {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/ec_volume_details.templ`, Line: 64, Col: 100}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/ec_volume_details.templ`, Line: 68, Col: 117}
			}
		...
		if !data.IsComplete {
			...
			for i, shardID := range data.MissingShards {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/ec_volume_details.templ`, Line: 81, Col: 99}
				}
		...
		for i, dc := range data.DataCenters {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/ec_volume_details.templ`, Line: 93, Col: 70}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/ec_volume_details.templ`, Line: 100, Col: 102}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/ec_volume_details.templ`, Line: 106, Col: 104}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/ec_volume_details.templ`, Line: 125, Col: 98}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/ec_volume_details.templ`, Line: 131, Col: 103}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/ec_volume_details.templ`, Line: 137, Col: 96}
		}
		...
		for _, shard := range data.Shards {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/ec_volume_details.templ`, Line: 148, Col: 108}
			}
		...
		if len(data.MissingShards) > 0 {
			...
			for _, shardID := range data.MissingShards {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/ec_volume_details.templ`, Line: 155, Col: 108}
				}
		...
		if len(data.Shards) > 0 {
			...
			for _, shard := range data.Shards {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/ec_volume_details.templ`, Line: 243, Col: 110}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/ec_volume_details.templ`, Line: 246, Col: 106}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/ec_volume_details.templ`, Line: 247, Col: 81}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/ec_volume_details.templ`, Line: 251, Col: 103}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/ec_volume_details.templ`, Line: 254, Col: 99}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/ec_volume_details.templ`, Line: 257, Col: 83}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/ec_volume_details.templ`, Line: 260, Col: 110}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `admin/view/app/ec_volume_details.templ`, Line: 263, Col: 121}
				}
