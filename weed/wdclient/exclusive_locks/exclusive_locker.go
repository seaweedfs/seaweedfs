...
func (l *ExclusiveLocker) RequestLock(clientName string) {
	...
	for {
		if err := l.masterClient.WithClient(false, false, func(client master_pb.SeaweedClient) error {
...
func (l *ExclusiveLocker) ReleaseLock() {
	...
	l.masterClient.WithClient(false, false, func(client master_pb.SeaweedClient) error {
