...
func ReadFilerSignature(grpcDialOptions []grpc.DialOption, filer pb.ServerAddress) (filerSignature int32, readErr error) {
	if readErr = pb.WithFilerClient(false, filer, grpcDialOptions, func(client filer_pb.SeaweedFilerClient) error {
